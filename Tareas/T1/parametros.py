...
LISTA_EXCAVADORES = [EXCAVADOR_DOCENCIO, EXCAVADOR_TAREO, EXCAVADOR_HIBRIDO]
...
ARENA_INICIAL = random.choice([ARENA_NORMAL, ARENA_MOJADA, ARENA_ROCOSA, ARENA_MAGNETICA])
