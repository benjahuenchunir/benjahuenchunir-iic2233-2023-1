...
class DCChain:
    ...
    def verificar_cadena(self):
        ...
        while nodo_actual:
            ...
            hash_padre = nodo_actual.hash_padre
            valor_hash = 0 if nodo_actual.padre is None else self.funcion_hash(nonce, transacciones, hash_padre)
            if valor_hash != nodo_actual.valor_hash:
                return False
