...
class VentanaControlRemoto(QWidget):
    ...
    def generar_layout(self):
        ...
        hbox = QHBoxLayout()
        hbox.addLayout(self.generar_layout_subir_bajar(self.volumen, "Volumen"))
        hbox.addLayout(self.generar_layout_subir_bajar(self.canales, "Canales"))
